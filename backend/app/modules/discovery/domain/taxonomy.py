...
_STOPWORDS: frozenset[str] = frozenset(
    {
        "the", "and", "for", "with", "you", "our", "are", "job", "role", "team",
        "we", "to", "of", "in", "at", "on", "a", "an", "is", "be", "as", "or",
        "intern", "internship", "senior", "junior", "lead", "staff", "remote",
        "onsite", "hybrid", "fulltime", "parttime", "vietnam", "hanoi",
    }
)
...
_ROLE_FAMILIES: dict[str, tuple[str, ...]] = {
    "software_engineering": (
        ...
        "devops", "mobile", "android", "ios", "programmer",
    ),
    "data_ai": (
