...
_STRINGS: dict[str, dict[str, str]] = {
    "vi": {
        ...
        "generic_resource": (
            "Xây dựng một dự án nhỏ trong hồ sơ năng lực để chứng minh {skill}, hoặc "
            "thêm một dòng vào CV mô tả kinh nghiệm thực tế của bạn với kỹ năng này "
            "nếu bạn đã có."
        ),
    ...
    "en": {
        ...
        "generic_resource": (
            "Build a small portfolio project that demonstrates {skill}, or add a line "
            "to your CV describing real experience with it if you already have some."
        ),
...
def _learning_gaps(result: dict | None, *, locale: str = _DEFAULT_LOCALE) -> list[dict]:
    ...
    return [
        {
            "skill": gap,
            "suggestion": _t(locale, "generic_resource", skill=gap),
