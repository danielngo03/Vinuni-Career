...
@pytest.mark.asyncio
async def test_superadmin_can_create_and_read_draft_graph(db_session) -> None:
...
@pytest.mark.asyncio
async def test_university_admin_with_ai_settings_manage_is_denied(db_session) -> None:
    _user, _org, admin = await make_org_with_admin(db_session, org_type="university")
