...
| 2026-06-11 | Add CV analysis as a separate agent | Fold CV into JD router vs separate agent | CV parsing has its own upload, validation, and student storage workflow | `cv_analysis` creates local student profiles that matching can use with profiles marked as mock |
