        ...
        >
          <div className="mb-3 border-b border-[var(--border-default)] px-1 pb-3">
            <div className="flex h-9 items-center justify-between">
              ...
              {threads.length > 0 && (
                <span className="rounded-full bg-[var(--workspace-canvas)] px-2 py-1 text-xs font-semibold text-[var(--text-secondary)] shadow-[inset_0_0_0_1px_rgba(0,0,0,0.055)]">
                  {threads.length}
                </span>
              )}
            </div>
            ...
            <div className="mt-2 flex h-9 items-center gap-2 rounded-full border border-[var(--border-default)] bg-[var(--workspace-canvas)] px-3 text-[var(--text-secondary)] focus-within:border-[var(--border-strong)] focus-within:bg-white">
