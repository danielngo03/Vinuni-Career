...
export const aiAssistantApi = {
  ...
  /** Upload a file to a session (multipart). Returns a safe descriptor. The
   * backend rejects blank/oversized/unsupported/failed-scan files with a
   * user-safe 4xx whose message the caller surfaces. */
