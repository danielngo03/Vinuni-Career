# Hướng dẫn dùng Claude Design để dựng 20 slide

Tài liệu này giải thích **chính xác** claude.ai/design là gì, và **2 luồng** để biến bộ spec trong folder
`slide/` thành một deck 20 slide hoàn chỉnh. Chọn 1 trong 2 — khuyến nghị **Luồng A** cho nhanh, dùng
...
- **claude.ai/design** là không gian **design-system project** trên claude.ai: bạn đẩy các file HTML preview
  ...
  một nút ra 20 slide — nó là nơi *chứa & xem* các artifact HTML bạn tạo ra.
...
Dùng khi bạn muốn **20 slide nằm gọn trong 1 design-system project** trên claude.ai/design, xem dạng lưới
...
- Ở máy, mở Claude Code trong repo. Yêu cầu:
  *"Đọc `slide/02-DECK-SPEC.md` và `slide/03-BRAND-DESIGN-SYSTEM.md`. Tạo 20 file HTML tự chứa tại
  `slide/deck/slide-01.html` … `slide-20.html`, mỗi file là 1 slide 16:9 hoàn chỉnh theo đúng spec, dùng
...
| Muốn quản lý 20 slide như thư viện card, chỉnh lẻ từng slide, dùng lại | **Luồng B (design-sync)** |
